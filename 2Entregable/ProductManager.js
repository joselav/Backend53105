...
class ProductManager {
    ...
    constructor(){
        this.path = "./products.json" //Ruta donde se guardaran los productos.
    }
   ...
   async addProduct(title, description, price, thumbnail, code, stock){
    ...
    async updateProduct(id,product){
        ...
        if(index != -1){
            ...
            return "Producto no encontrado o inexistente";
        }
    }
    ...
    async deleteProduct(id){
        ...
        if(deleteProd){
            ...
            return `Producto con id ${id} no encontrado o inexistente.`
        }
    }
}
